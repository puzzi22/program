     ...
     */ value: function createNode(tag) {
                ...
                },
                {
                    ...
                    value: function getTransitionEvent(optEl) {
                        if (transitionEvent && !optEl) return transitionEvent;
                        transitionEvent = "";
                        ...
                        for(var i = 0, length = transitionNames.length; i < length && !transitionEvent; i++){
                            ...
                            if (typeof el.style[transitionName] !== "undefined") transitionEvent = transitions[transitionName];
                        }
                ...
                },
                {
                    ...
                    value: function getAnimationEvent(optEl) {
                        if (animationEvent && !optEl) return animationEvent;
   ...
   */ _createClass(Slide, [
                ...
                },
                {
                    ...
                    value: function getSectionFromEl(el) {
                        ...
                        var section = null;
                        var i = null;
                        while(parent.parentElement && !parent.classList.contains(CLASSES.SLIDE))parent = parent.parentElement;
 ...
 */ function scrollTo(y) {
            ...
            var animateScroll = function animateScroll(elapsedTime) {
                ...
                if (elapsedTime < duration) setTimeout(function() {
   ...
   */ _createClass(WebSlides, [
                {
                    ...
                    value: function removeChildren_() {
                        ...
                        while(i--){
                            var node = nodes[i];
                            if (!__WEBPACK_IMPORTED_MODULE_1__slide__["b" /* default */ ].isCandidate(node)) this.el.removeChild(node);
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function goToSlide(slideI) {
                        ...
                        if (this.isValidIndexSlide_(slideI) && !this.isMoving && this.currentSlideI_ !== slideI) {
                            ...
                            if (forward !== null) isMovingForward = forward;
                            else if (this.currentSlideI_ >= 0) isMovingForward = slideI > this.currentSlideI_;
                            var nextSlide = this.slides[slideI];
                            if (this.currentSlide_ !== null && this.isVertical && (!this.plugins.touch || !this.plugins.touch.isEnabled)) this.scrollTransitionToSlide_(isMovingForward, nextSlide, this.onSlideChange_);
                            else this.transitionToSlide_(isMovingForward, nextSlide, this.onSlideChange_);
                        }
                    }
                },
                {
                    ...
                    value: function scrollTransitionToSlide_(isMovingForward, nextSlide, callback) {
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_3__utils_scroll_to__["a" /* default */ ])(nextSlide.el.offsetTop, 500, function() {
                            ...
                            if (isMovingForward) _this2.currentSlide_.moveAfterLast();
                ...
                },
                {
                    ...
                    value: function transitionToSlide_(isMovingForward, nextSlide, callback) {
                        ...
                        if (this.currentSlide_) {
                            if (isMovingForward) this.currentSlide_.moveAfterLast();
                        ...
                        } else callback.call(this, nextSlide);
                    }
                },
                {
                    key: "onSlideChange_",
                    value: function onSlideChange_(slide) {
                        if (this.currentSlide_) this.currentSlide_.disable();
                ...
                },
                {
                    ...
                    value: function initSlides_() {
                        ...
                        // Not valid
                        if (slideNumber === null || slideNumber >= this.maxSlide_) slideNumber = 0;
                        // Keeping the order
                        if (slideNumber !== 0) {
                            var i = 0;
                            while(i < slideNumber){
                ...
                },
                {
                    ...
                    value: function toggleZoom() {
                        if (this.options.showIndex) this.plugins.zoom.toggleZoom();
                    }
                },
                {
                    key: "disable",
                    value: function disable() {
                        ...
                        if (this.plugins.autoslide && this.plugins.autoslide.time !== false) this.plugins.autoslide.stop();
                    }
                },
                {
                    key: "enable",
                    value: function enable() {
                        ...
                        if (this.plugins.autoslide && this.plugins.autoslide.time !== false) this.plugins.autoslide.play();
                    }
                },
                {
                    key: "isDisabled",
                ...
                },
                {
                    ...
                    value: function fullscreen() {
                        ...
                        if (!isFullscreen) {
                            /* istanbul ignore next hard to test prefixes */ var requestFullscreen = el.requestFullscreen || el.webkitRequestFullScreen || el.mozRequestFullScreen || el.msRequestFullscreen;
                            requestFullscreen.call(el);
                        } else {
                            /* istanbul ignore next hard to test prefixes */ var cancelFullscreen = document.exitFullScreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen;
   ...
   */ _createClass(AutoSlide, [
                {
                    ...
                    value: function onFocus() {
                        if (__WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* default */ ].isFocusableElement()) this.stop();
                        else if (this.interval_ === null) this.play();
                    }
                },
                {
                    key: "play",
                    value: function play(time) {
                        ...
                        this.time = time;
                        if (!this.interval_ && typeof time === "number" && time > 0) this.interval_ = setInterval(this.ws_.goNext.bind(this.ws_), time);
                    }
                },
                {
                    key: "stop",
 ...
 */ function canIuseNativeCustom() {
            ...
            /* istanbul ignore next: hard to reproduce on test environment  */ return false;
        }
        /**
 ...
 * @return {Event}
 * @constructor
 */ /* istanbul ignore next: hard to reproduce on test environment  */ var IECustomEvent = function CustomEvent(type, params) {
            var e = document.createEvent("CustomEvent");
            if (params) e.initCustomEvent(type, params.bubbles, params.cancelable, params.detail);
            else e.initCustomEvent(type, false, false, undefined);
            return e;
        };
        /* istanbul ignore next: hard to reproduce on test environment  */ var WSCustomEvent = canIuseNativeCustom() ? NativeCustomEvent : IECustomEvent;
 ...
 */ var ClickNav = function() {
   ...
   */ function ClickNav(wsInstance) {
     ...
     * @private
     */ this.ws_ = wsInstance;
                if (wsInstance.options.changeOnClick) this.ws_.el.addEventListener("click", this.onClick_.bind(this));
            }
            /**
   ...
   */ _createClass(ClickNav, [
                {
                    ...
                    value: function onClick_(event) {
                        if (CLICKABLE_ELS.indexOf(event.target.tagName) < 0 && typeof event.target.dataset.preventNav === "undefined") this.ws_.goNext();
                    }
                }
            ]);
            return ClickNav;
    ...
    /* 11 */ /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var GRID_IMAGE = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYAgMAAACdGdVrAAAACVBMVEUAAAAtXsUtXcPDDPUWAAAAA3RSTlMAZmHzZFkxAAAAFklEQVQI12MAA9bBR3ExhAJB1iooBQBGwgVEs/QtuAAAAABJRU5ErkJggg==";
        /**
   ...
   */ _createClass(Grid, [
                {
                    ...
                    value: function onKeyPress_(event) {
                        if (event.which === __WEBPACK_IMPORTED_MODULE_0__utils_keys__["a" /* default */ ].ENTER) document.body.classList.toggle("baseline");
                    }
                }
            ]);
            return Grid;
   ...
   */ _createClass(Hash, [
                {
                    ...
                    value: function onHashChange_() {
                        ...
                        if (newSlideIndex !== null) this.ws_.goToSlide(newSlideIndex);
                    }
                }
            ], [
                {
                ...
                },
                {
                    ...
                    value: function getSlideNumber() {
                        ...
                        if (typeof slide !== "number" || slide < 0 || !Array.isArray(results)) slide = null;
                        else slide--; // Convert to 0 index
                        return slide;
                    }
                },
                {
                    ...
                    value: function setSlideNumber(number) {
                        if (Hash.getSlideNumber() !== number - 1) history.pushState({
                            slideI: number - 1
   ...
   */ _createClass(Keyboard, [
                {
                    ...
                    value: function onKeyPress_(event) {
                        var method = void 0;
                        var argument = void 0;
                        if (__WEBPACK_IMPORTED_MODULE_1__utils_dom__["a" /* default */ ].isFocusableElement() || this.ws_.isDisabled()) return;
                        switch(event.which){
                            ...
                            case __WEBPACK_IMPORTED_MODULE_0__utils_keys__["a" /* default */ ].SPACE:
                                if (event.shiftKey) method = this.ws_.goPrev;
                                else method = this.ws_.goNext;
                                break;
                            ...
                            case __WEBPACK_IMPORTED_MODULE_0__utils_keys__["a" /* default */ ].F:
                                if (!event.metaKey && !event.ctrlKey) method = this.ws_.fullscreen;
                                break;
                        }
                        if (method) {
   ...
   */ _createClass(Navigation, [
                ...
                },
                {
                    ...
                    value: function updateCounter(current, max) {
                        if (this.ws_.options.showIndex) this.counter.childNodes[0].textContent = current + " / " + max;
                        else this.counter.textContent = current + " / " + max;
                    }
                },
                {
                    key: "onSlideChanged_",
     ...
     */ value: function onSlideChanged_(event) {
                ...
                },
                {
                    ...
                    value: function onButtonClicked_(event) {
                        event.preventDefault();
                        if (event.target === this.next) this.ws_.goNext();
                        else if (event.target === this.prev) this.ws_.goPrev();
                        else this.ws_.toggleZoom();
                    }
                }
            ], [
                {
 ...
 */ var Scroll = function() {
   ...
   */ function Scroll(wsInstance) {
     ...
     */ this.timeout_ = null;
                ...
                if (!this.ws_.options.navigateOnScroll) return;
                if (!__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */ ].isAny()) {
                    ...
                    if (!wsInstance.isVertical) wsInstance.el.addEventListener("ws:slide-change", this.onSlideChange_.bind(this));
                }
            }
            /**
   ...
   */ _createClass(Scroll, [
                ...
                },
                {
                    ...
                    value: function onMouseWheel_(event) {
                        ...
                        var wheelDeltaY = event.deltaY, wheelDeltaX = event.deltaX;
                        ...
                        if (isHorizontalMovement) {
                            if (!isVertical) event.preventDefault();
                            else // If we're moving horizontally but this is vertical, return to avoid
                            // unwanted navigation.
                            return;
                        }
                        if (Math.abs(wheelDeltaY + linesToPx) >= this.ws_.options.minWheelDelta || Math.abs(wheelDeltaX + linesToPx) >= this.ws_.options.minWheelDelta) {
                            if (isHorizontalMovement && this.isGoingLeft_ || !isHorizontalMovement && this.isGoingUp_) this.ws_.goPrev();
                            else this.ws_.goNext();
                            event.preventDefault();
                        }
                    }
                }
 ...
 */ var Touch = function() {
   ...
   */ function Touch(wsInstance) {
     ...
     */ this.endTouches = [];
                ...
                if (__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */ ].isAny()) {
                    // Likely IE
                    if (window.PointerEvent && (__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */ ].isWindows() || __WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */ ].isWindowsPhone())) events = EVENTS.pointer;
                    else events = EVENTS.touch;
                    this.isEnabled = true;
   ...
   */ _createClass(Touch, [
                ...
                },
                {
                    ...
                    value: function onMove_(event) {
                        if (this.ws_.isDisabled()) return;
                        var info = Touch.normalizeEventInfo(event);
                        if (this.isGesture) this.endTouches = Touch.getTouchCoordinates(event);
                        else {
                            this.endX_ = info.x;
                            this.endY_ = info.y;
                        }
                ...
                },
                {
                    ...
                    value: function onStop_() {
                        ...
                        if (this.isGesture) {
                            ...
                            if (startDistance > endDistance) // Pinch gesture
                            this.ws_.toggleZoom();
                            this.isGesture = false;
                        } else {
                            ...
                            if (Math.abs(diffX) > Math.abs(diffY)) {
                                if (diffX < -this.ws_.options.slideOffset) this.ws_.goPrev();
                                else if (diffX > this.ws_.options.slideOffset) this.ws_.goNext();
                            }
                        }
                    }
                }
                ...
                },
                {
                    ...
                    value: function normalizeEventInfo(event) {
                        ...
                        if (typeof event.changedTouches !== "undefined") touchEvent = event.changedTouches[0];
                        else if (typeof event.originalEvent !== "undefined" && typeof event.originalEvent.changedTouches !== "undefined") touchEvent = event.originalEvent.changedTouches[0];
 ...
 */ var Video = function() {
   ...
   */ function Video(wsInstance) {
     ...
     */ this.ws_ = wsInstance;
                ...
                if (videos.length) videos.forEach(function(video) {
                    if (!video.hasAttribute("autoplay")) return;
                    video.removeAttribute("autoplay");
                    video.pause();
                    video.currentTime = 0;
                    var _Slide$getSectionFrom = __WEBPACK_IMPORTED_MODULE_1__modules_slide__["b" /* default */ ].getSectionFromEl(video), i = _Slide$getSectionFrom.i;
   ...
   */ _createClass(Player, [
                ...
                },
                {
                    ...
                    value: function onPlayerReady() {
                        ...
                        if (this.timeout && this.player.getPlayerState() !== 1) this.play();
                        if (this.onReadyCb) {
                            this.onReadyCb();
                            this.onReadyCb = null;
                        }
                ...
                },
                {
                    ...
                    value: function play() {
                        ...
                        } else this.onReadyCb = this.play;
                    }
                },
                {
                    key: "pause",
                    value: function pause() {
                        if (this.player && this.player.pauseVideo && this.player.getPlayerState() === 1) this.player.pauseVideo();
                    }
                },
                {
                    key: "getPlayerVars",
                    value: function getPlayerVars(element) {
                        ...
                        if (this.slide.classList.contains("fullscreen")) // Disabling keyboard interaction for fullscreenvideos
                        vars.disablekb = 1;
 ...
 */ var YouTube = function() {
   ...
   */ function YouTube(wsInstance) {
     ...
     */ this.ws_ = wsInstance;
                ...
                if (this.videos.length) this.inject();
            }
            /**
   ...
   */ _createClass(YouTube, [
                    ...
                    value: function onYTReady() {
                        ...
                        this.videos.forEach(function(video) {
                            ...
                            if (typeof video.dataset.autoplay !== "undefined") {
                                var _Slide$getSectionFrom = __WEBPACK_IMPORTED_MODULE_1__modules_slide__["b" /* default */ ].getSectionFromEl(player.el), i = _Slide$getSectionFrom.i;
                                ...
                                if (_this2.ws_.currentSlide_ === slide) YouTube.onSectionEnabled(slide);
                            }
                        });
                    }
                },
                ...
                },
                {
                    ...
                    value: function onSectionEnabled(slide) {
                        if (slide.player.autoplay) slide.player.play();
                    }
                },
                {
                    key: "onSectionDisabled",
   ...
   */ _createClass(Zoom, [
                {
                    ...
                    value: function onKeyDown(event) {
                        if (!this.isZoomed_ && __WEBPACK_IMPORTED_MODULE_1__utils_keys__["a" /* default */ ].MINUS.some(function(key) {
                            ...
                            return key === event.which;
                        }) || event.which === __WEBPACK_IMPORTED_MODULE_1__utils_keys__["a" /* default */ ].ESCAPE)) this.zoomOut();
                    }
                },
                {
                    key: "preBuildZoom_",
                ...
                },
                {
                    ...
                    value: function zoomIn() {
                        ...
                        if (zoomedCurrent) zoomedCurrent.classList.remove(CLASSES.CURRENT);
...
//# sourceMappingURL=index.6eca53f5.js.map
